...
export default function About() {
  ...
  return (
    <div>
      ...
      <div className="accordion" id="accordionExample" style={modeStyle}>
  <div className="accordion-item" style={modeStyle}>
    <h2 className="accordion-header" style={modeStyle}>
...
<button type="button" className='btn btn-primary my-3' onClick={modeSwitch} >{btnText}</button>
</div>
